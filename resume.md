...
- актуальное: сменил python-стэк, asyncio + aiohttp + peewee, postgres, SQL, rabbitmq, kubernetes, pytest, небольшой сайд-проект с aiogram. Погружаюсь в PostgreSQL всё глубже и глубже.
- в прошлом: Nginx/Openresty, Flask + Alembic + Postgres + uWSGI + Celery, Bootstrap, JWT, OpenVZ, IMAP.
- в давнем прошлом: bash, C, сети, реалтайм анализ трафика, файрволы, iptables, статистика, хранение и агрегация данных, linux kernel, сетевой стек, сборка ПО, прогнозирование производительности оборудования.
