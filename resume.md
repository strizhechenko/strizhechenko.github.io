...
- **2025-сейчас, АО "Точка"**, Лидер круга, тимлид.
   - За полгода построил процессы разработки в кросс-функциональной команде (design -> SA -> QA -> FE & BE -> QA),
   - Отладил мониторинг динамики метрик (WIP, lead и cycle time, пропускная способность с дифференциацией задач), что сделало разработку прогнозируемой,
   - Анализировал интересы, выявил лидерские компетенции и помог членам команды составить вектора дальнейшего профессионального роста.
   - Отладил в команде процессы собеседования и онбординга новых участников. Почти привёл команду к целевому состоянию, когда уход одного из членов в отпуск или на больничный не выбивает из ритма.
   - Принял факт, что прямое включение меня в разработку - плохая идея, замедляет и разработку и отнимает ресурсы у команды.
   - Работаю сильно в другом стиле, чем до этого, в Carbon Soft (менее авторитарно, стараюсь быть просто катализатором изменений).
- **2022-2025, АО "Точка"**, Senior Backend Developer.
