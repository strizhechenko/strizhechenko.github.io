...
- [Обо мне](#Обо мне)
- [Контакты/ссылки](#Контакты/ссылки)
  - [Связанные с программированием](#Связанные с программированием)
  - [Прочее](#Прочее)
- [Образование](#Образование)
- [Языки](#Языки)
- [Проекты в которых участовал](#Проекты в которых участовал)
- [Навыки](#Навыки)
  - [bash](#bash)
  - [python](#python)
    - [Веб](#Веб)
  ...
  - [Мониторинги, метрики](#Мониторинги, метрики)
  - [Визуализация данных](#Визуализация данных)
  - [Виртуализация](#Виртуализация)
  - [Документация, блоги](#Документация, блоги)
  - [CSS](#CSS)
  - [Javascript](#Javascript)
  - [Ansible](#Ansible)
  - [Вторичные навыки](#Вторичные навыки)
  - [Что я хочу подучить получше](#Что я хочу подучить получше)
- [Прочитанные книги по программированию](#Прочитанные книги по программированию)
- [Читаемые книги по программированию](#Читаемые книги по программированию)
- [Предпочитаемые операционные системы](#Предпочитаемые операционные системы)
...
Зарплатные ожидания: 85000-200000 рублей/месяц, в зависимости от того, где и над чем работать + прозрачные условия прироста.
...
- Русский (родной)
- Английский - pre-intermediate, посещаю курсы + изучаю самостоятельно.

## Проекты в которых участовал

- Начинающий системный администратор в нескольких компаниях (1 год)
- Tandem University - система автоматизации ВУЗов. Q/A (тестировщик).
- Ideco ASR / Ideco AS / Carbon Billing 4 - основанный на Linux софтроутер и биллинг для интернет-провайдеров размером 1000-10000 абонентов. Q/A, техническая поддержка, разработчик.
- Carbon PL5 - Linux-дистрибутив для поставки приложений Carbon Soft, оформленных в виде chroot'ов и набор утилит для управления ими. Основной разработчик.
- Carbon Billing 5 - биллинг для интернет-провайдеров размером до 100000 абонентов. В основном помогал решать коллегам системные, специфичные для Linux и сетевые проблемы. Разработчик.
- Carbon XGE Router 5 - основанный на Linux софтроутер. Занимался сетевой начинкой из файрвола, шейперов, ipset, а также максимально быстрой интеграцией с Carbon Billing 5. Основной разработчик.
- Carbon Reductor - система фильтрации трафика для провайдеров с производительностью до 100000 абонентов на сервер. Используется более чем у 400 провайдеров в РФ. Сейчас занимаюсь только им. Ведущий разработчик, продукт менеджер.
...
Очень хороший язык, особенно если вся команда использует одинаковые инструменты для работы с ним. К сожалению специфика работы пока что мало даёт с ним работать, так что в основном я его использовал в различных pet-project'ах.
...
Tweepy, Telepot, Dictator, Pymorphy2 - есть у меня небольшое хобби, клепать ботов в твиттер во славу автоматической генерации забавного контента.

Tweepy лежит в основе двух врапперов для того, чтобы максимально быстро и удобно разворачивать новых ботов:

1. [twitterbot-utils](https://github.com/strizhechenko/twitterbot-utils) - набор общих сценариев использования tweepy.
2. [twitterbot-farm](https://github.com/strizhechenko/twitterbot-farm) - всё для построения связок из нескольких ботов с целью снижения числа запросов к twitter API и возможности крутить всё в одном месте, а не в heroku, где бесплатных часов довольно мало.
...
Проблема: застрял на RHEL6/CentOS6 из-за политики Carbon Soft. Вообще, хотелось бы освежить навыки и поработать с более современными системами, пощупать systemd где-то кроме домашнего localhost итд.
...
Чудесный инструмент, которому быстро обучаются новички и который очень экономит время и снижает вероятность проблем из-за человеческого фактора. Пользуюсь ansible-lint.
...
## Читаемые книги по программированию
