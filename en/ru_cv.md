...
Зарплатные ожидания: 85000-200000 рублей/месяц. Само собой всё обсуждаемо и зависит от того:

- где (страна, город)
- над чем (интересно, полезно для портфолио, греет душу, применимы имеющиеся навыки)
- и сколько (легко/сложно)

работать + насколько прозрачные условия прироста ЗП.
...
- знаком непонаслышке с такими ценностями разработки ПО как надёжность, поддерживаемость и скорость.
- уважаю коллег и всегда тестирую свой код перед отправкой в тесты/production.
...
- прекрасно себя чувствую, когда от бизнеса есть рекомендации по уровням качества, надёжности и скорости разработки.
...
- умею искать готовые opensource решения и адаптировать их, при необходимости, вместо написания велосипедов.
...
Одним из примеров моего кода (не самый лучший код, но зато в открытом доступе) может служить [Carbon Reductor Satellite](https://github.com/carbonsoft/reductor_satellite_installer) - система для проверки работы фильтрации, аналог АС Ревизор.
