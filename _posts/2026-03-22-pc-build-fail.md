...
- Жена подарила на день рождения блок питания на 850W с модульными кабелями. Минус лапша, лучше поток воздуха, наверное чуть лучше охлаждение.
- Купил серверный шкаф на 9U под стол (~10000р), полку (1000р) и USB-блок вентиляторов (500р), потому что сын активно лез к проводам и руками и зубами. Туда же запрятал и ИБП. 
- Сменил **GPU**. Снова. RTX4060Ti отправилась на авито за 34500р, её место заняла RTX5060Ti 16gb (не подгадал момент и взял её за 54999р, хотя мог за 47999р). Нейронки стали шустрее на 10-50%. В размере ничего не изменилось, ну и ладно.
- Пришлось искать где-то HDMI-DP кабель, который будет вывозить 2560x1440, потому что в новой видеокарте 3хDP, 1xHDMI. Ещё -650р.

Итого:

- На комплюктор потрачено ещё ~42000 рублей, внутренний ребёнок доволен, гарантия на видеокарту продлилась на 1 год.
- Был бы ещё довольнее, если бы не цены на оперативку. Так бы давно уже пересел на Ryzen 9700x + 2x64gb DDR5 6000MHz. Оффлоад в RAM сейчас основное бутылочное горлышко для крупных LLM в моём сетапе.
