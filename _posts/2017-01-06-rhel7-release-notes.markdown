...
Выпилить pidgin в пользу empathy? Это звучит тоскливо с одной стороны, а с другой - как давно я их юзал?
...
1. Они ж бля его выпилили в пользу empathy
2. Чо за Microsoft Lync?
3. Какой вообще год, чтобы читать про pidgin в Linux дистрах?
## NetworkManager и вообще вся сетевая подсистема

Вот там ещё про nmcli упомянули.

У меня из-за NetworkManager стабильно возникают проблемы с виртуализацией, так что я использую статичные конфиги бриджей, а его выпиливаю.

Бриджи и бонды теперь вроде в гуе почти что можно настраивать. Так-то прикольно.
...
Еще забавно переименование kernel-firmware в linux-firmware. Звучит как ПИНГВИНОКАПЕЦ и скорый приход Hurd!
...
Думаю стоит напомнить: сеть в виртуалках - говна кусок и вы ничего с этим не сделаете (ну ок, побрызгать освежителем воздуха можете).

Хочу бенчмаркать RHEL6 + QEMU/KVM vs RHEL7 QEMU/KVM, потому что zero copy в сетке из коробки звучит ну оочень вкусно, а стендов с RHEL7 нет(
...
В RHEL7.2 много маленьких радостей:
...
816426029359173633 Узнал про 3 версии архитектуры Intel Core i{3,5,7} чисто из доков редхата. Наверное когда-нибудь я даже задумаюсь о покупке одного из них.
816426745763164164 Про iputils радует. Хочу фичу, которую мне самому впадлу сделать:  ping https://t.co/QFgy23grut который вырезает из… https://t.co/DNnlwGZk48
816427861481549828 Не хочу читать подробности про это, хочу бенчмаркать свои частные случаи говнокода! https://t.co/wwTYSpzZl2
816428164473831424 Интересно, как долго длится memtest86 для 2Tb RAM?
...
816577837113241600 “NetworkManager now detects duplicate IPv4 addresses”  Да он это вроде с 6.2 версии еще делать умеет.
...
816762082691600384 Ну наконец-то!  (вообще хочу поведение при котором LRO включен по умолчанию и вырубается при первом же FORWARD-паке… https://t.co/2kMitQeWPt
