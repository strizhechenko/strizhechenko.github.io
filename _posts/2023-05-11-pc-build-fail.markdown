...
Переключение я устроил так - usb-свитч, два HDMI-кабеля воткнуты в монитор. Для переключения клавиатуры нажимается кнопочка на USB-свитче, а потом кнопочка на мониторе для переключения источника. Неудобно две кнопки нажимать. Вторым монитором я не пользуюсь, хотя казалось бы - разберись уже с usb type-c -> displayport и будет счастье. Может заряжать ноут от монитора можно будет, ну или монитор от ноутбука питать, но это не точно. Блок питания ноута (гигантский, весит больше чем Macbook Pro 15 наверное) прикрутил стяжками к столу и норм.

В начале вторых майских праздников я сдался и купил с мыслью "хватит уже гадать, бери любой" корпус Fractal Design Node 304 на 19 литров и ATX-блок питания BeQuiet Pure Power 11 на 500Вт. За два часа прикрутил блок питания к корпусу, процессор, оперативную память и NVMe к материнской плате. У корпуса есть корзины на 6 дисков, но у материнки 4 SATA-гнезда, а дисков в проекте и вовсе не было. Можно внутрь RPi спрятать. У задней панельки материнки внутри приклеена странная смягчающая подкладка из пленки и чего-то ещё. Раньше такого не видел, наверное что-то для людей, но она отталкивает материнку назад и приходится её придерживать, чтобы прикрутить болтами.
...
Огроменная связка проводов от блока питания - 2 x 6+2 PCI-E, 5 x SATA, FDD (!) - не упёрлась, а деть некуда. Да, это ATX, расчитан под размер ATX корпуса. Получился не кабель менеджмент, а ужас. Загиб силового кабеля нарисован в инструкции Fractal Design. Длина удлинителя на 10см больше чем нужно. Процессорный кулер Noctua N9A смешно в этом корпусе смотрится, но я изначально планировал вариант покомпактнее, а эта коробка позволяет послать пргрмрвне подальше, воткнуть видеокарту, Windows и играть себе в игрулечки аки малое дитятко на шее у жены.

Стяжки - это шибари для задротов.
...
3. Кабель питания включен напрямую в БП.
4. О, кофе.
5. Ну разумеется вчера в суете перепутал POWER SW с POWER LED.

Включается. Ненавижу эту часть компьютеров (пины фронтальной панели) на том же уровне, что и разъёмы питания CPU и материнки. Осознал, что нет кнопки reset. Вот думаю, что делать с тремя корзинами для дисков - кажется тупо хранить в шкафу, пока не прижмёт. А ещё я наконец-то выкину эти коробки из-под железок с подоконника.
...
Сосед из ЖК, в который я ещё не переехал, но в чаты повступал, подогнал для теста 2х2400гц модуля. Если заведётся (5%) и обновлю BIOS (раньше этого не делал, тут отдельные 20% на успех) и эту совместимость исправили в новой прошивке (5%), то загружусь со своими модулями. 5% х 5% х 20% = 1 к 2000. Облом произошёл на первых 5%, грустно.

В днс вчера сказали что у них есть сервис в торговчике X. Сегодня сказали что только в торговчике Y мне помогут. Поехал, там инженер на неделю на больничном. Решил - куплю новую. В наличии 1шт. В торговчике X. Приехал за минуту до закрытия, но в эту минуту закрыли вход в торговчик. Боже, хочу камплютир, сколько ж можно.

Купил новую, собрал, при старте те же 3 long beep. Да што ш такое. Разбираю, повезу сдавать через возврат, алиэкспрессную попробую сдать в диагностику, если починят - продать на Avito. Собрал материнку назад в коробку ещё аккуратнее чем было.
